 ...
 **/
//根据商品ID获取商品图片url
export const GetProductImg = (params) => { return req("post", "/api/product/admin/getProductImg", params) };
// 商品管理-获取商品管理列表
export const GoodsList = (params) => { return req("post", "/api/product/admin/getAllProduct", params) };
// 商品管理-保存商品管理
